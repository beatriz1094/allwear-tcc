...
async function enviarEmailCliente(emailCliente, senhaProvisoria) {
    ...
    let mailOptions = {
        ...
        text: `Olá, seu acesso provisório ao sistema de All Wear é:\nSenha: ${senhaProvisoria}\nAcesse o sistema e altere sua senha assim que possível.`
    };

    try {
        await transporter.sendMail(mailOptions);
        console.log('E-mail enviado para o usuario:', emailCliente);
    } catch (error) {
        console.error('Erro ao enviar e-mail para o usuario:', error);
    }
}
